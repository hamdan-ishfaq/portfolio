...
const ProjectFormSchema = z.object({
  ...
  github_repo: z.string().nullable().optional().or(z.literal('')),
  loom_video_id_demo: z.string().nullable().optional().or(z.literal('')),
  loom_video_id_arch: z.string().nullable().optional().or(z.literal('')),
  linkedin_url: z.string().nullable().optional().or(z.literal('')),
  live_demo_url: z.string().nullable().optional().or(z.literal('')),
...
export async function upsertProject(
  ...
  if (!parsed.success) {
    console.error('Validation failed for project:', parsed.error.format());
    return {
      success: false,
